...
namespace gsv {
  ...
  enum Enum_CommandIndentifier  {
	 ...
	 CI_DrawMode /*! Ustawia tryb rysowania (Fill lub Line) */,
	 CI_ShowLocalCrds /*! Rysuje lokalny układ współrzędnych */,
	 CI_ShowBgTexture /*! Rysuje lub nie rysuje teksturę tła */,
	 CI_BgColor /*! Zmienia kolor tła */,
	 CI_BgImage /*! Zmiana tekstury tła */
  };
