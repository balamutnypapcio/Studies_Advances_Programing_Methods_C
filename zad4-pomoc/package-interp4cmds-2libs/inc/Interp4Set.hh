...
/*!
 * \brief Modeluje polecenie dla robota mobilnego, które wymusza jego ruch w okół wybranej osi
 *
 *  Klasa modeluje ...
 */
class Interp4Set: public AbstractInterp4Command {
  // Pola na parametry polecenia Set
  Vector3D  _Position;  // Zakładamy, że używamy klasy Vector3D z projektu
  Vector3D  _Orientation; // np. jako kąty Yaw, Pitch, Roll
